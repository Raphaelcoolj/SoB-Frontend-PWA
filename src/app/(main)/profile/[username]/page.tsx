...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-4 pb-16 -mt-1.5 lg:-mt-3 overflow-x-hidden max-w-full">
          ...
          {isOwnProfile ? (
            <>
              <button
                ...
                className="flex-1 min-w-0 py-1.5 px-3 rounded-full border border-border bg-card hover:bg-muted text-xs font-semibold text-foreground transition-all duration-200 cursor-pointer text-center active:scale-[0.98]"
              >
                Share
              </button>
              <Link
                href="/settings/profile"
                className="flex-1 min-w-0 py-1.5 px-3 rounded-full border border-border bg-card hover:bg-muted text-xs font-semibold text-foreground transition-all duration-200 text-center active:scale-[0.98] flex items-center justify-center"
              >
                Edit profile
              </Link>
            </>
            ...
            <>
              ...
              {!isBlockedByViewer && (
                <div className="flex-1 min-w-0">
                  <FollowButton
                    ...
                    className="w-full h-8 rounded-full text-[11px] font-semibold border border-border bg-card text-foreground hover:bg-muted transition-all duration-200 active:scale-95"
                  />
                </div>
              )}
              ...
              {!isBlockedByViewer && !isOwnProfile && (profile.isFollowing || profile.isFollowedBy) && (
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-1 px-3 h-8 rounded-full text-[11px] font-semibold border border-border bg-accent text-white hover:opacity-90 transition-all duration-200 active:scale-95 cursor-pointer flex-shrink-0"
                >
              ...
              {currentUser && (
                <BlockButton
                  ...
                  className={`
                    inline-flex items-center justify-center gap-1 px-3 h-8 rounded-full text-[11px] font-semibold
                    border transition-all duration-200 active:scale-95 disabled:opacity-50 cursor-pointer flex-shrink-0
                    ${isBlockedByViewer
              ...
              {currentUser && !isOwnProfile && !isBlockedByViewer && (
                <button
                  ...
                  className="px-2.5 h-8 rounded-full border border-border bg-card text-muted-foreground hover:text-destructive hover:border-destructive/30 hover:bg-destructive/5 transition-all cursor-pointer flex items-center justify-center flex-shrink-0"
